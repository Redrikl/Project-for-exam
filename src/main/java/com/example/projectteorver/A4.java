...
public class A4 extends Namber{
    ...
    @Override
    public String get(){
        return ". Для студента Петрова вероятность сдать на «отлич\n" +
                "но» экзамен по высшей математике равна "+vero1+", а по физи\n" +
                "ке — "+vero2+". Для студента Васильева эти вероятности равны\n" +
